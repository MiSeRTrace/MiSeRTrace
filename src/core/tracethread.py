        ...
        if record.isImplementation:
            ...
            # RECEIVING LOGIC
                ...
                if record.event == "tcp_rcv_space_adjust":
                    # print("iWon", self.traceProcessor.gatewayIP)
                            ...
                            if isRequest:
                                ...
                                for networkStateKey in self.intermediateThreadStates:
                                    ...
                                    if (
                                        ...
                                        and sourceIPToBeChecked
                                        == netState.srcSocket.srcIp
                                ...
                                try:
                                    for (
                                        networkStateKey
                                    ) in sourceThread.networkThreadStates:
                                    ...
                                    print(
                                        "TERMINATING FIRST PASS: Error with tcp_probe"
                                    )
